    ...
    <View className="border-b border-border px-4 py-3">
      ...
      <View className="flex-row items-center gap-2">
        ...
        {!isDesktop && (
          <Pressable
            accessibilityRole="button"
            className="h-9 flex-row items-center gap-2 rounded-[10px] bg-highlight px-4 shadow-inset-xs"
          >
            <Icon name="star-outline" size={16} className="text-primary" />
            <Text className="text-h5 font-sans-medium text-primary">Fan in All Access</Text>
          </Pressable>
        )}
